...
class AboutDialog(wx.Dialog):
    def _init_ctrls(self, prnt):
        ...
        self.staticText3 = wx.StaticText(id=wxID_ABOUTDIALOGSTATICTEXT3,
              label=u'Written by Roger Plowman and Matthias C. Hormann', name='staticText3', parent=self,
        ...
        self.staticText4 = wx.StaticText(id=wxID_ABOUTDIALOGSTATICTEXT4,
              label=u'Copyright  1998–2016', name='staticText4', parent=self,
        ...
        self.OK_Button = wx.Button(id=wxID_ABOUTDIALOGOK_BUTTON, label=u'Ok',
        ...
        self.textCtrl1 = wx.TextCtrl(id=wxID_ABOUTDIALOGTEXTCTRL1,
              ...
              value=u'Website: https://github.com/Moonbase59/PAWS')
